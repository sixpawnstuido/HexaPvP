...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPBanners
    {
        ...
        [Preserve]
        static void SetupBannersBackgroundIOS(GameObject ttpGameObject)
        {
            Debug.Log("TTPBanners:: SetupBannersBackgroundIOS");
            if (Application.platform == RuntimePlatform.IPhonePlayer){
                Debug.Log("TTPBanners:: SetupBannersBackgroundIOS:: on iOS, adding white background.");
                var bannersBackgroundPrefab = Resources.Load<GameObject>("Prefabs/BannersBackground");
                bannersBackgroundPrefab = GameObject.Instantiate(bannersBackgroundPrefab);
                GameObject.DontDestroyOnLoad(bannersBackgroundPrefab);
                bannersBackgroundPrefab.name = "TTPBannersBackground";
                bannersBackgroundPrefab.SetActive(true);
                bannersBackgroundPrefab.GetComponent<TTPBackgroundController>().Setup();
            }
        }
        /// <summary>
