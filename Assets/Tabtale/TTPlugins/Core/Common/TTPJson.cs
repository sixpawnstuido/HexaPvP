        ...
        sealed class Serializer
        {
            ...
            void SerializeOther(object value)
            {
                if (value is float floatVal) {
                    builder.Append(floatVal.ToString(CultureInfo.InvariantCulture));
                }
                else if (value is double doubleVal) {
                    builder.Append(doubleVal.ToString(CultureInfo.InvariantCulture));
                }
                else if (value is decimal decimalVal) {
                    builder.Append(decimalVal.ToString(CultureInfo.InvariantCulture));
                }
