...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPPrivacySettings
    {
        ...
        public static bool ShouldShowPrivacySettings()
        {
            TTPLogger.Log("TTPPrivacySettings::ShouldShowPrivacySettings:");
            if (Impl != null)
                return Impl.ShouldShowPrivacySettings();
            return true;
        }
        ...
        private class IosImpl : IPrivacySettings {
            ...
            [DllImport("__Internal")]
            private static extern bool ttpShouldShowPrivacySettings();
            ...
            public bool ShouldShowPrivacySettings()
            {
                return ttpShouldShowPrivacySettings();
            }
        }
#endif
        ...
        private class AndroidImpl : IPrivacySettings {
            ...
            public bool ShouldShowPrivacySettings()
            {
                if (ServiceJavaObject != null)
                {
                    return ServiceJavaObject.Call<bool>("shouldShowPrivacySettings");
                }
                return true;
            }
        }
