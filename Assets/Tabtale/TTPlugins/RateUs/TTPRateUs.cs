...
namespace Tabtale.TTPlugins
{
    public class TTPRateUs
    {
        ...
        private static void LogPopUpEvent(string eventName, bool show, bool noInternet, string response)
        {
            ...
            {
                System.Reflection.MethodInfo method = analyticsClsType.GetMethod("LogEvent",
                    new Type[] {    typeof(long), typeof(string), typeof(IDictionary<string, object>), typeof(bool), typeof(bool)   });
                if (method != null)
                {
