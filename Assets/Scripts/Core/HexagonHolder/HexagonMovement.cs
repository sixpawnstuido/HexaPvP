...
public class HexagonMovement : MonoBehaviour,IPointerDownHandler,IPointerUpHandler
{
    ...
    [ShowInInspector,ReadOnly] public static bool isMoving;
    [ShowInInspector,ReadOnly] public static bool HexagonClickBlock;
    [ShowInInspector,ReadOnly] public static bool PvPBlock;
    ...
    private void OnClickEndState()
    {
        _canMove = false;
        var gridHolder =
            RaycastManager.SendRayFromCameraToMousePos<GridHolder>(_gridHolderLayerMask, true, _fingerDistance);
